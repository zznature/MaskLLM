...
if [ "$MODEL" == "7b" ]; then
   ...
   NUM_LAYERS=40 # number of layers
   NUM_ATTN_HEADS=40 # number of attention heads
   TOKENIZER_MODEL="$PROJECT_DIR/assets/checkpoints/llama2_13b_megatron_tp8/tokenizer.model"
